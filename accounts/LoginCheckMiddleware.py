        ...
        if user.is_authenticated:
            if user.user_type == "1":
                ...
                if modulename == "slm_app.StaffViews":
                    pass
                elif modulename == "slm_app.views" or modulename == "slm_app.EditResultViewClass":
                    pass
                else:
            ...
            if request.path == reverse("show_login") or request.path == reverse("dologin") or modulename == "django.contrib.auth.views" or modulename=="django.contrib.admin.sites" or modulename=="slm_app.views":
                pass
            else:
